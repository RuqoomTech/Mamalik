...
export const VISIBLE_BORDER_TARGET_AREA_M2 = STARTING_USABLE_LAND_M2;
export const VISIBLE_BORDER_STRICT_MIN_M2 = 49_000;
export const VISIBLE_BORDER_STRICT_MAX_M2 = 51_000;
export const VISIBLE_BORDER_LOOSE_MIN_M2 = 45_000;
export const VISIBLE_BORDER_LOOSE_MAX_M2 = 55_000;
