...
- [ ] Water, overlap, and restricted zones are rejected.
...
- Real restricted-zone checks, dynamic area-type buffers, and nearby suggestions remain pending follow-up Sprint 4 tasks.
