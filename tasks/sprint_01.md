...
- [ ] S1-002: Initialize minimal monorepo structure: `apps/web`, `packages/db`, `packages/game`, `packages/config`, `workers/tick-worker`.
- [ ] S1-003: Install/configure Next.js, TypeScript, Tailwind, lint, and basic scripts.
